...
class _AllRecipesViewState extends State<AllRecipesView> {
  ...
  // Globar string with user search input
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Scaffold(
          ...
          body: Column(
            children: <Widget>[
              searchBar(),
              filtersExpandablePanel(
                theme,
                viewHeight,
                constraints,
              ),
              _isSearching ? loadingDisplay(theme) : recipesDisplay(theme)
            ],
          ),
        );
      },
  ...
  // FILTERS PANEL
  ExpansionPanelList filtersExpandablePanel(
      ThemeData theme, double viewHeight, BoxConstraints constraints) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: filterComponentWithSearchBar(
                        theme,
                        "Składniki",
                        "wyszukaj składnik",
                        _ingredientsNames,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        _batchNumber = 0;
                        _loadMoreRecipes();
                        _displaySearchResults(userSearchInput);
  ...
  Column filterComponentWithSearchBar(
      ThemeData theme,
      String labelName,
      String hintLabelName,
      List<String> autocompeteDataList,
              ...
              Expanded(
                child: Autocomplete<String>(
                  optionsBuilder: (TextEditingValue textEditingValue) {
                    ...
                    return autocompeteDataList.where(
                      (object) => object.contains(textEditingValue.text),
                    );
                  },
  ...
  // Card display with a loading circle
