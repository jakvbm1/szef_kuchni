...
class _RecipeViewState extends State<RecipeView> {
  ...
  AppBar recipeAppBar(BuildContext context) {
    ...
    (
      title: Text(
        ...
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.thumb_up, color: recipe.isFavourite?Colors.blueAccent:Colors.black),
            onPressed: (){
              setState(() {
              ...
              if(recipe.isFavourite) {displayedText = 'added to favourites!';}
  ...
  Padding foodStats()
  {
    ...
    String time;
    if(widget.recipe.minutes < 60){time = '${widget.recipe.minutes} min';}
    else
    {
    ...
    (
      ...
      (
        ...
        children: 
        [
          Text(time, style: const TextStyle(fontSize: 36, fontWeight: FontWeight.w600),),
